...
const GlowCard = ({ children, className, delay = 0 }: { children: React.ReactNode; className?: string; delay?: number }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative group rounded-md border border-white/10 bg-[#0f2540]/40 backdrop-blur-xl overflow-hidden",
        className
      )}
    >
...
const Header = () => (
  <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-1 border-b border-white/5 bg-[#081A2E]/80 backdrop-blur-md">
    ...
    <div className="flex items-center gap-4">
      ...
      <Link href="/auth/register" className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-cyan-500 to-blue-600 rounded-sm hover:shadow-[0_0_20px_rgba(60,198,231,0.5)] transition-all text-center">
        Get Started
      </Link>
    </div>
  </header>
    ...
    <section className="relative min-h-[80vh] flex flex-col items-center justify-center pt-24 pb-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto px-4">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-cyan-500/20 rounded-sm blur-3xl animate-pulse" />
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-sm opacity-80 shadow-[0_0_80px_rgba(60,198,231,0.5)]" />
            <div className="absolute inset-1.5 bg-[#081A2E] rounded-sm flex items-center justify-center border border-white/10 overflow-hidden">
              ...
              {['Idea' , 'Strategy', 'Roadmap' , 'Execution'].map((item, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <motion.div
                        className="w-4 h-4 rounded-sm bg-cyan-300"
                        animate={{ scale: [1, 1.5, 1], boxShadow: ["0 0 10px #22d3ee", "0 0 25px #22d3ee", "0 0 10px #22d3ee"] }}
                        transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                      />
                      <span className="text-[12px] whitespace-nowrap uppercase tracking-[0.2em] text-cyan-100 font-bold bg-[#081A2E]/80 border border-cyan-500/30 px-3 py-1 rounded-sm backdrop-blur-md shadow-lg">
                        {item}
                      </span>
                    </div>
                  </motion.div>
        ...
        >
          <Link href="/auth/register" className="group relative px-8 py-4 bg-white text-[#081A2E] rounded-sm font-bold text-lg hover:scale-105 transition-transform overflow-hidden text-center">
          ...
          <a href="#showcase" className="px-8 py-4 rounded-sm font-medium text-lg text-white border border-white/20 hover:bg-white/5 transition-colors backdrop-blur-sm text-center">
      ...
      <motion.div
        className="pointer-events-none fixed top-0 left-0 w-[500px] h-[500px] bg-cyan-500/10 rounded-sm blur-[100px] z-0"
    ...
    <section id="showcase" className="py-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative group flex justify-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-cyan-500/10 rounded-sm blur-[120px] opacity-50 group-hover:opacity-80 transition duration-1000" />
          <div className="relative w-full max-w-5xl">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full max-w-2xl px-6 text-center z-20">
              <div className="inline-flex items-center gap-2 mb-2 px-3 py-1 rounded-sm bg-cyan-500/10 border border-cyan-500/30 backdrop-blur-md">
              ...
              <div className="flex justify-center gap-4 mt-4">
                <div className="px-4 py-2 bg-white/5 backdrop-blur-xl rounded-sm border border-white/10 text-white text-xs font-medium">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-4">
              {points.map((p, i) => (
                <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.1 }} className="flex gap-4 p-4 rounded-sm bg-white/5 border border-white/10 hover:border-cyan-500/30 transition-colors">
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-md blur opacity-20 group-hover:opacity-40 transition" />
            <div className="relative bg-[#0f2540] border border-white/10 rounded-md p-8 shadow-2xl">
              ...
              <div className="mt-8 flex justify-center">
                <div className="relative w-16 h-16 flex items-center justify-center">
                  <div className="absolute inset-0 bg-cyan-500/20 rounded-sm animate-ping" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {levels.map((l, i) => (
            <div key={i} className={cn(
              "p-6 rounded-md border transition-all duration-500",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 relative">
            <div className="absolute inset-0 bg-purple-500/10 rounded-sm blur-[100px]" />
            <div className="relative grid grid-cols-2 gap-4">
              <div className="p-6 rounded-md bg-[#0f2540] border border-purple-500/20 flex flex-col items-center text-center h-full">
              ...
              <div className="p-6 rounded-md bg-[#0f2540] border border-cyan-500/20 flex flex-col items-center text-center h-full">
              ...
              <div className="p-6 rounded-md bg-[#0f2540] border border-blue-500/20 flex flex-col items-center text-center h-full">
              ...
              <div className="p-6 rounded-md bg-[#0f2540] border border-green-500/20 flex flex-col items-center text-center h-full">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((f, i) => (
            <GlowCard key={i} delay={i * 0.1} className="min-h-[240px]">
              <div className="w-12 h-12 rounded-sm bg-white/5 flex items-center justify-center mb-6 border border-white/10">{f.icon}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {steps.map((step, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.2 }} className="relative flex flex-col items-center text-center group">
                <div className="relative z-10 w-16 h-16 rounded-md bg-[#0f2540] border border-white/10 flex items-center justify-center mb-6 group-hover:border-cyan-500/50 group-hover:shadow-[0_0_30px_rgba(60,198,231,0.3)] transition-all duration-500">
                  <div className="text-slate-300 group-hover:text-cyan-400 transition-colors">{step.icon}</div>
                  {i === 1 && <div className="absolute inset-0 rounded-md bg-cyan-500/20 animate-ping" />}
                </div>
                <h4 className="text-white font-medium mb-2">{step.label}</h4>
                <div className="h-1 w-8 bg-cyan-500/50 rounded-sm" />
                {i < steps.length - 1 && (
...
const FinalCTA = () => (
  <section className="py-4 relative">
    <div className="max-w-4xl mx-auto px-6 text-center">
      <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative p-12 rounded-md overflow-hidden border border-white/10 bg-[#0f2540]">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/auth/register" className="px-8 py-4 bg-white text-[#081A2E] rounded-sm font-bold text-lg hover:scale-105 transition-transform shadow-[0_0_40px_rgba(255,255,255,0.3)] text-center">Initialize Operating System</Link>
            <Link href="/auth/login" className="px-8 py-4 bg-transparent border border-white/20 text-white rounded-sm font-medium text-lg hover:bg-white/5 transition-colors text-center">Login</Link>
          </div>
        </div>
      </motion.div>
    </div>
      ...
      <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          <div className="flex -space-x-2">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-6 h-6 rounded-sm bg-slate-800 border-2 border-[#081A2E] flex items-center justify-center">
