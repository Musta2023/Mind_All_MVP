...
const GlowCard = ({ children, className, delay = 0 }: { children: React.ReactNode; className?: string; delay?: number }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative group rounded-xl border border-white/10 bg-[#0f2540]/40 backdrop-blur-xl overflow-hidden",
        className
      )}
    >
...
const Header = () => (
  <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-1 border-b border-white/5 bg-[#081A2E]/80 backdrop-blur-md">
    ...
    <div className="flex items-center gap-4">
      ...
      <Link href="/auth/register" className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl hover:shadow-[0_0_20px_rgba(60,198,231,0.5)] transition-all text-center">
        Get Started
      </Link>
    </div>
  </header>
  ...
  return (
    <section className="relative min-h-[80vh] flex flex-col items-center justify-center pt-24 pb-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto px-4">
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{
                        transform: `rotate(${angle}deg) translateX(240px) rotate(-${angle}deg) rotateX(-75deg) rotateY(10deg)`,
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          background: "radial-gradient(circle at 30% 30%, #2FD3FF, #0284C7 60%, #081A2E 100%)",
                          boxShadow: "inset -2px -2px 4px rgba(0,0,0,0.5), 0 0 20px rgba(47,211,255,0.4)",
                          transformStyle: "preserve-3d"
                        }}
                      >
                        <div className="absolute top-1.5 left-1.5 w-3 h-3 rounded-full bg-white/40 blur-[1px]" />
                        <Icon className="w-6 h-6 text-white relative z-10 drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
                      </motion.div>
                      
                      <span className="text-[12px] whitespace-nowrap uppercase tracking-[0.2em] text-cyan-100 font-bold bg-[#081A2E]/90 border border-cyan-500/40 px-3 py-1.5 rounded-xl backdrop-blur-md shadow-[0_0_15px_rgba(2,132,199,0.3)]">
                        {item.label}
                      </span>
                    </div>
                  </motion.div>
        ...
        >
          <Link href="/auth/register" className="group relative px-8 py-4 bg-white text-[#081A2E] rounded-xl font-bold text-lg hover:scale-105 transition-transform overflow-hidden text-center">
          ...
          <a href="#showcase" className="px-8 py-4 rounded-xl font-medium text-lg text-white border border-white/20 hover:bg-white/5 transition-colors backdrop-blur-sm text-center">
        ...
        <div className="relative group flex justify-center">
          ...
          <div className="relative w-full max-w-5xl">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full max-w-2xl px-6 text-center z-20">
              <div className="inline-flex items-center gap-2 mb-2 px-3 py-1 rounded-xl bg-cyan-500/10 border border-cyan-500/30 backdrop-blur-md">
              ...
              <div className="flex justify-center gap-4 mt-4">
                <div className="px-4 py-2 bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 text-white text-xs font-medium">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl blur opacity-20 group-hover:opacity-40 transition" />
            <div className="relative bg-[#0f2540] border border-white/10 rounded-xl p-8 shadow-2xl">
              <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/5">
                <span className="text-xs font-mono text-cyan-400">STRATEGY_HEALTH_SCORE: 94%</span>
                <span className="px-2 py-1 bg-green-500/20 text-green-400 text-[10px] rounded-xl uppercase font-bold tracking-widest">Active Alignment</span>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 + i * 0.1 }} className="flex items-center justify-between">
                    ...
                    <div className={cn("text-[9px] font-mono px-2 py-0.5 rounded-xl", item.status === "VERIFIED" ? "text-green-400 bg-green-500/10 border border-green-500/20" : "text-yellow-400 bg-yellow-500/10 border border-yellow-500/20")}>
          ...
          {levels.map((l, i) => (
            <div key={i} className={cn(
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span className={cn(
                  "px-2 py-0.5 rounded-xl text-[9px] font-bold uppercase",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 relative">
            ...
            <div className="relative grid grid-cols-2 gap-4">
              <div className="p-6 rounded-xl bg-[#0f2540] border border-purple-500/20 flex flex-col items-center text-center h-full">
              ...
              <div className="p-6 rounded-xl bg-[#0f2540] border border-cyan-500/20 flex flex-col items-center text-center h-full">
              ...
              <div className="p-6 rounded-xl bg-[#0f2540] border border-blue-500/20 flex flex-col items-center text-center h-full">
              ...
              <div className="p-6 rounded-xl bg-[#0f2540] border border-green-500/20 flex flex-col items-center text-center h-full">
...
const WorkflowDiagram = () => {
  const steps = [
    { label: "Identity DNA", icon: <Database className="w-6 h-6" />, color: "from-blue-500 to-cyan-500" },
    { label: "Intelligence Router", icon: <Cpu className="w-6 h-6" />, color: "from-cyan-400 to-blue-500" },
    { label: "Strategic Ledger", icon: <ShieldCheck className="w-6 h-6" />, color: "from-blue-600 to-indigo-600" },
    { label: "90-Day Blueprint", icon: <LineChart className="w-6 h-6" />, color: "from-indigo-500 to-purple-500" },
    { label: "Tactical Execution", icon: <Zap className="w-6 h-6" />, color: "from-purple-500 to-pink-500" },
  ];
  ...
  return (
    <section id="workflow" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-cyan-500/20 to-transparent -translate-y-1/2" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">The Strategic Pipeline</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">From raw data to tactical deployment in a self-reinforcing intelligence loop.</p>
          </motion.div>
        </div>

        <div className="relative">
          {/* Main Connector Line (Desktop) */}
          <div className="absolute top-12 left-[10%] right-[10%] h-[2px] bg-white/5 hidden md:block">
            <motion.div
              className="h-full bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-500 shadow-[0_0_15px_rgba(34,211,238,0.5)]"
              initial={{ width: "0%" }}
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="relative z-10 w-24 h-24 mb-6">
                  ...
                  {/* Glow Effect */}
                  <div className={cn(
                    "absolute inset-0 rounded-full blur-xl opacity-0 group-hover:opacity-40 transition-opacity duration-500 bg-gradient-to-br",
                    step.color
                  )} />

                  {/* Node Circle */}
                  <div className="relative h-full w-full rounded-full bg-[#081A2E] border border-white/10 flex items-center justify-center group-hover:border-white/30 transition-all duration-500 shadow-2xl">
                    <div className={cn(
                      "absolute inset-1 rounded-full opacity-10 group-hover:opacity-20 bg-gradient-to-br",
                      step.color
                    )} />
                    <motion.div
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      className="text-slate-300 group-hover:text-white transition-colors drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]"
                    >
                      {step.icon}
                    </motion.div>
                  </div>
                  ...
                  {/* Step Number */}
                  <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-slate-900 border border-white/10 flex items-center justify-center text-[10px] font-bold text-cyan-400 shadow-lg">
                    0{i + 1}
                  </div>
                </div>
                ...
                >
                  <h4 className="text-white font-bold text-sm mb-2 tracking-wide group-hover:text-cyan-400 transition-colors">
                    {step.label}
                  </h4>
                  <div className={cn(
                    "h-[2px] w-8 mx-auto rounded-full bg-gradient-to-r opacity-40 group-hover:opacity-100 transition-all duration-500",
                    step.color
                  )} />
                </motion.div>
                ...
                {i < steps.length - 1 && (
                  <div className="md:hidden h-12 w-[1px] bg-gradient-to-b from-white/10 to-transparent my-4" />
                )}
              </motion.div>
            ))}
          </div>
...
const FinalCTA = () => (
  <section className="py-4 relative">
    <div className="max-w-4xl mx-auto px-6 text-center">
      <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative p-12 rounded-xl overflow-hidden border border-white/10 bg-[#0f2540]">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/auth/register" className="px-8 py-4 bg-white text-[#081A2E] rounded-xl font-bold text-lg hover:scale-105 transition-transform shadow-[0_0_40px_rgba(255,255,255,0.3)] text-center">Initialize Operating System</Link>
            <Link href="/auth/login" className="px-8 py-4 bg-transparent border border-white/20 text-white rounded-xl font-medium text-lg hover:bg-white/5 transition-colors text-center">Login</Link>
          </div>
        </div>
      </motion.div>
    </div>
